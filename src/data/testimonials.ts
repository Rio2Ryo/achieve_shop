...
export const testimonialCases: TestimonialCase[] = [
  {
    ...
    quote: {
      JP: '年齢とともに頬のシミやクマが目立っていたのですが、使い始めてから肌がふんわり明るくなり、自信が戻りました。大人の肌でも無理なく使えるのが嬉しいです。',
      EN: 'Age spots and dark circles used to stand out, but after three weeks my skin looks brighter and confidence returned. It works gently even on mature skin.'
    },
    beforeNote: {
  ...
  },
  {
    ...
    quote: {
      JP: '頬の毛穴が引き締まり、赤みも落ち着きました。素肌がきれいになったみたいで、化粧直しの回数がぐっと減りました。毎日の必需品です。',
      EN: 'My pores tightened and redness calmed down. It feels like my bare skin improved, so I need far fewer touch-ups. It has become my daily essential.'
    },
    beforeNote: {
  ...
  },
  {
    ...
    quote: {
      ...
      EN: 'Dark spots gradually faded and my complexion evened out. It reminded me that with the right care, skin responds beautifully at any age.'
    },
    beforeNote: {
